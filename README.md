...
I'm a results-driven Senior Full-Stack Software Engineer with deep expertise in **backend-heavy systems**, **AI integration**, and **scalable web platforms**. I architect production-ready APIs, internal tools, and AI-powered workflows that bridge intelligent systems with robust infrastructure.

&gt; "I don't just build software — I engineer value."

---

## What I Do

- **AI/ML Systems** – LLMs (Llama, Mistral via Ollama), RAG with LangChain/FAISS, Computer Vision, NLP, Predictive Analytics
- **Full-Stack Web Development** – Next.js, React, FastAPI, Node.js, TypeScript, Tailwind CSS
- **Backend Architecture** – Microservices, REST APIs, Real-time Systems, PostgreSQL, MongoDB, Redis
- **Automation & DevOps** – Docker, Kubernetes, CI/CD, GitHub Actions, AWS, Prometheus, Grafana
- **Data Science** – Predictive Modeling, Feature Engineering, Analytics Dashboards
...
|---------|-------------|------------|
| **Multi-Vendor Marketplace Platform** | Marketplace ecosystem with storefront, vendor panel, and admin control. Integrated Stripe for payouts, Algolia for search, and TalkJS for real-time chat | Next.js, Node.js, FastAPI, PostgreSQL, Redis, Stripe, Algolia, TalkJS |
| **MyResumeAI** | Rule-based resume evaluation platform delivering transparent, evidence-backed scoring metrics | Next.js 15, TypeScript, Prisma, PostgreSQL, Redis |
| **ScholarAI** | Open-source privacy-preserving AI research assistant for secure document analysis using local LLMs | Gemini API, TensorFlow.js, FastAPI, Ollama, Tesseract.js |
...
- **Artificial Intelligence** — HP Life (2025)
...
&gt; "Let your code think, let your product speak, and the user smile."

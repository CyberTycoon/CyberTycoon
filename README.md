...
### OpenLotus
Post-development intelligence platform for founders — multi-agent workspace (FastAPI, Pydantic AI, LangGraph), persistent chat, tool-calling, full auth. Built solo, end to end.

`FastAPI` `Pydantic AI` `LangGraph` `Next.js` `MCP`
